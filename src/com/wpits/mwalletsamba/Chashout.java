...
public class Chashout extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chashout);
...
Toast.makeText(getApplicationContext(), "Please enter a valid amount", Toast.LENGTH_LONG).show();					// TODO: handle exception
	...
	public class Cashout extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pd = ProgressDialog.show(Chashout.this, "Cash out in progress  ",
					"Please Wait");
		}
...
if(mPin_EditText.getVisibility()==View.VISIBLE)
{
	...
	String str = httpTransfer.httptransfer(mobile_no, dest_mobile_no, mPin_EditText.getText().toString(), amount, "cashout", "CashOut", "");
    Toast.makeText(getApplicationContext(), str, Toast.LENGTH_LONG).show();
	String otp = "";
	Bundle b = new Bundle();
	b.putString("mobile_no", mobile_no);
	b.putString("otp", otp);
	Intent in = new Intent(Chashout.this, AndroidGridLayoutActivity.class);
	...
	HttpTransfer httpTransfer = new HttpTransfer();
	String str = httpTransfer.httptransfer(mobile_no, dest_mobile_no, mPin, amount, "cashout", "CashOut", "");
    Toast.makeText(getApplicationContext(), str, Toast.LENGTH_LONG).show();
	String otp = "";
	Bundle b = new Bundle();
	b.putString("mobile_no", mobile_no);
