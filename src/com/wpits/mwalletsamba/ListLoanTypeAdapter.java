...
public class ListLoanTypeAdapter extends BaseAdapter{
	private Context mContext;
	private ArrayList<SpinnerModel> mMessages;



	public ListLoanTypeAdapter(Context context, ArrayList<SpinnerModel> messages) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null)
		{
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.loan_type_list_item_edit, parent, false);
