...
public class PayToActivity extends Activity {
	EditText dest_mobile_no_EditText,amount_EditText,remarkEditText;
	String dest_mobile_no,amount,mobile_no,remark,accounttype;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pay_to);
	...
	public class Transfer extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPreExecute() {
			...
			pd = ProgressDialog.show(PayToActivity.this, "Transferring  ",
					"Please Wait");
		}
		...
		protected void onPostExecute(Boolean strFromDoInBg) {
			pd.dismiss();
			if (strFromDoInBg) {
				Transferobject object=new Transferobject(userobject.getUserDetails().getUserMobile(), dest_mobile_no, amount, remark, System.currentTimeMillis()+"", Utility.TRANSFER_MSAKO, accounttype);
