...
public class Httptopup {
	String responseregcont;
	private Context context;
	public String httptopup(String srcmobile,String destmobile,String mpin,String amount,String type,String remark,String oprater ){
...
System.out.println(oprater);
			...
			HttpPost httppost = new HttpPost(GlobalIpConfigration.URL_BANK+"TopupService");
