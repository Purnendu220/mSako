...
public class HttpLogout {
	...
	String[] splitval ;
	public UserLogoutParser httpuserlogout(Context context,String mobileno,String session_id)
	{
		this.context = context;
		//dao=new TodoDAO(context);
		UserLogoutParser parser = null;
		...
		try {
			...
			HttpPost httppost = new HttpPost(GlobalIpConfigration.URL_BANK_MSAKO+"user_logout");
			...
			{
				parser=new UserLogoutParser(responseregcont);
