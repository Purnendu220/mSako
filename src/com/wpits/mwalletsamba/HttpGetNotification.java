...
public class HttpGetNotification {
	String responseregcont;
	private Context context;
	String[] splitval ;
	public NotificationResponse httpusernotification(Context context,String mobileno,String mpin,String usertype,String session_id)
	{
		this.context = context;
		//dao=new TodoDAO(context);
		NotificationResponse parser = null;
		...
		try {
			...
			obj.put("req_type", "notification");
			HttpClient httpclient = new DefaultHttpClient();
			HttpPost httppost = new HttpPost(GlobalIpConfigration.URL_BANK_MSAKO+"user_notifications");
			...
			{
				parser=new NotificationResponse(responseregcont);
