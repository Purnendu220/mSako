...
public class RegisterActivity extends Activity {
	...
	EditText dob_EditText ;
 	...
 	String name ,	alternate_mobile,    nrc,  dob,  mPin , re_mPin,type,mobile_no,otp_gen,email,address;       
        ...
        // Listening to Login Screen link
            ...
            public void onClick(View arg0) {
            	...
            	if(name!=null && name.length()<=0 ){
            		...
            		RadioGroup radioTypeGroup = (RadioGroup) findViewById(R.id.radioType);
	...
	public class Transfer extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pd = ProgressDialog.show(RegisterActivity.this, "Registering ",
					"Please Wait");
		}
...
runOnUiThread(new Runnable() {
	...
	public void run() {
		 Httpsendregistration httpsendregistration = new Httpsendregistration();
		    boolean registered = httpsendregistration.sendregistration(mobile_no, otp_gen, name, mPin, nrc, alternate_mobile, dob, type,address,email,"");
 		...
 		if(registered){
         	...
         	Intent in = new Intent(RegisterActivity.this, AndroidGridLayoutActivity.class);
         	in.putExtras(b);
         	startActivity(in);
        	finish();
