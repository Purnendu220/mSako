...
public class Register_Agent extends Activity {
...
String type="Agent";
	...
	public class Transfer extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pd = ProgressDialog.show(Register_Agent.this, "Registering ",
					"Please Wait");
		}
...
runOnUiThread(new Runnable() {
	...
	public void run() {
		 Httpsendregistration httpsendregistration = new Httpsendregistration();
		    boolean registered = httpsendregistration.sendregistration(mobile_no, otp_gen, name, mPin, nrc, alternate_mobile, dob, type,address,email,"Agent");
 		...
 		/*    Editor editor = pref.edit();
     		...
     		*/
         	...
         	Intent in = new Intent(Register_Agent.this, AndroidGridLayoutActivity.class);
         	in.putExtras(b);
         	startActivity(in);
        	finish();
