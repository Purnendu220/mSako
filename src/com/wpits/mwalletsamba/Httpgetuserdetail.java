...
public class Httpgetuserdetail {
	String responseregcont;
	private Context context;
	String[] splitval ;
	public ArrayList<ModelUserData> httpgetuserdetail(Context context,String mobileno)
	{
		...
		try {
			...
			HttpPost httppost = new HttpPost(GlobalIpConfigration.URL_BANK+"UserRecord");
			...
			{
				UserDetailParser parse=new UserDetailParser();
				ministatement=	parse.parsedata(responseregcont);
